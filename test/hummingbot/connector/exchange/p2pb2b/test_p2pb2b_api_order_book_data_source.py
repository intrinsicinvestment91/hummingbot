...
class P2pb2bAPIOrderBookDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.connector = P2pb2bExchange(
            ...
            domain=self.domain)
        self.data_source = P2pb2bAPIOrderBookDataSource(trading_pairs=[self.trading_pair],
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.p2pb2b.p2pb2b_api_order_book_data_source"
           ".P2pb2bAPIOrderBookDataSource._sleep")
