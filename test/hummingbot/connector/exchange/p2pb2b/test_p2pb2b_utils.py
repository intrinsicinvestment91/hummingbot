...
class P2pb2bUserStreamDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.auth = P2pb2bAuth(api_key="TEST_API_KEY", secret_key="TEST_SECRET", time_provider=self.mock_time_provider)
        self.time_synchronizer = TimeSynchronizer()
        self.time_synchronizer.add_time_offset_ms_sample(0)

        client_config_map = ClientConfigAdapter(ClientConfigMap())
        self.connector = P2pb2bExchange(
        ...
        self.data_source = P2pb2bAPIUserStreamDataSource(
            auth=self.auth,
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.p2pb2b.p2pb2b_api_user_stream_data_source.P2pb2bAPIUserStreamDataSource._sleep")
    ...
    @patch("hummingbot.connector.exchange.p2pb2b.p2pb2b_api_user_stream_data_source.P2pb2bAPIUserStreamDataSource"
           "._ping_listen_key",
